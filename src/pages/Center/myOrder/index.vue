    ...
    <div class="order-content">
            ...
            <tr v-for="(orderDetail, index) in order.orderDetailList" :key="orderDetail.id">
              <td width="60%">
                <div class="typographic">
                  ...
                  <a href="#" class="block-text" style="display: block; width: 250px;">{{ orderDetail.skuName }}</a>
                  <span>x{{ orderDetail.skuNum }}</span>
                  <a href="#" class="service">售后申请</a>
                </div>
              </td>
              <!-- v-if="index===0"控制后面合并单元格的td只遍历一次 -->
      ...
      <div class="choose-order">
        ...
        <Pagination :pageNo="page" 
          :pageSize="limit" :total="myOrder.total" :continues="5" @getPageNo="getPageNo"/>
      </div>
    </div>
    <!--猜你喜欢-->
    <div class="like">
